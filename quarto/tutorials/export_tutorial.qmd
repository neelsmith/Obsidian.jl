...
To see how Obsidian notes are convereted to Markdown files, let's compare the contents of the source file for Abraham Lincoln and the corresponding output file.
