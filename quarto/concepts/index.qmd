...
Julia's excellent infrastructure around Markdown make it an appealing language for using Obsidian vaults outside the Obsidian app. The main goal of `Obsidian.jl` is to provide functionality for Obsidian content that is not pure Markdown: standard Obsidian's wiki links, tags, and properties, and the dataview plugin's format for inlink links.
